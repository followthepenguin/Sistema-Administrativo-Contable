...
public class EditorTablaEventos extends AbstractCellEditor implements TableCellEditor{
    ...
    public EditorTablaEventos(Eventos eventos, String nombreColumna)
    {
    ...
    public boolean stopCellEditing() {
        ...
        if(!nombreColumna.equals("id_trabajador_evento"))
        {
            if( !valorNuevo.equals(valorViejo))
            {   
                if(!eventos.modificar(Conexion.getConexion(),nombreColumna+"='"+valorNuevo+"' ", id ) )
                {   
